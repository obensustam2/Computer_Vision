...
################# PARAMETERS #####################
path = "myDataTrafficSign"  # folder with all the class folders
labelFile = 'label_traffic_signs.csv'  # file with all names of classes

testRatio = 0.2  # (%20) out of 1000 images, 200 of them will be used for testing
validationRatio = 0.2  # 200 images are used 800 are left. (%20) 160 of them will be used for validation
...
for x in range(0, len(myList)):
    ...
    print(x, end=" ")
print(" ")
print("Total Images in Images List:", len(images), ". Total IDS in classNo List:", len(classNo))
##################################################
...
pickle_out = open("model_trained_traffic_sign.p", "wb")  # wb = WRITE BYTE
